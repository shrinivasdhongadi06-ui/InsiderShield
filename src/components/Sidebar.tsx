...
export default function Sidebar({ isOpen, setIsOpen }: { isOpen?: boolean; setIsOpen?: (v: boolean) => void }) {
  ...
  return (
    <>
      ...
      <aside
        className={`w-64 border-r border-slate-200 bg-white/95 backdrop-blur-xl flex flex-col h-screen fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:sticky lg:top-0 lg:bg-white/90 ${isOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        {/* Logo */}
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1">          <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4 px-2">Monitoring</div>
        ...
        {/* Settings + Logout — pinned to sidebar bottom */}
